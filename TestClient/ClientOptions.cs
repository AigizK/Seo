...
namespace TestClient
{
    ...
    public sealed class ClientOptions : CommandLineOptionsBase
    {
        ...
        [Option("h", "http-port", DefaultValue = "16555", HelpText = "HTTP port on server")]
        ...
        [Option("s", "store", DefaultValue = @"C:\LokadData\itf-store", HelpText = "Location of data store to use")]
